...
global.sgc = 'https://chat.whatsapp.com/F6feHKBmpbc6MaQWFEK6aH' // group whatsapp
...
/*============== NOMOR ==============*/
global.nomorbot = '17038929748'
global.nomorown = '4915678377072'
global.namebot = 'Kurwa-Bot'
global.nameown = 'Kurwa James'
...
/*============== WATERMARK ==============*/
global.wm = '                「 Kurwa 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘Kurwa ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ Kurwa '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By Kurwa`
global.packname = '☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ'
global.author = '                「 Kurwa  あ」'
...
/*============== STICKER WM ==============*/
global.stickpack = 'Kurwa'
global.stickauth = `By Kurwa`
